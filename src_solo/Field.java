...
public class Field {
    ...
    public static final int[] LEVEL_THRESHOLD = {80, 80, 720, 1200, 1200, 1600, 3600};
    ...
    private ArrayList<Block> randomBlocksList(int startY) {
        ...
        for (int i=0; i<=height/ALTITUDE_GAP; i++) {
            ...
            bList.add(new Block(y, width, MIN_BLOCK_WIDTH[difficultyLevel], MAX_BLOCK_WIDTH[difficultyLevel]));
            y += ALTITUDE_GAP;
        }
        return bList;
    }
